...
It takes [HPO obo file](http://purl.obolibrary.org/obo/hp.obo) as argument and construct a tree with [networkx](https://networkx.github.io/) thanks to [obonet package](https://github.com/dhimmel/obonet).
